...
% It was tested by comparison of results with 'ProcCaDynamics_v1.m'
% Renamed from 'CmprtDendrCaDynamics.m'
...
filename = 'parameters_proc';%input('Specify name of model parameter file: ','s');
load(filename);
